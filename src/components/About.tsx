...
export default function About(): React.ReactElement {
  return (
    <React.Fragment>
      <Hero title="About" size={Size.SMALL} />
          ...
          <div className="columns">
            <div className="column is-three-fifths is-offset-one-fifth">
              <div className="home-section">
                ...
                <br />
                <p>
                  It&apos;s a constant work in progress. I have a job, so this is more of a passion project than
                  anything. The site might be broken occasionally, but since I use it myself I try to keep it in a
                  working state while adding on features every once in a while. If you discover something is wrong with
                  the website or you have a feature request please open an issue on{" "}
              ...
              <div className="home-section">
                ...
                <p>
                  ...
                  the videos for a single champion or concept. The site also utilizes lazy loading so it&apos;s
                  impractical to use a browsers built-in search to find content.
                </p>
              </div>
              <div className="home-section">
              ...
              <div className="home-section">
                ...
                <p>
                  ...
                  <br />
                  <br />
                  I&apos;m not making any kind of a profit through this tool. It&apos;s simply a project that I enjoy
                  working on and it allows me to use Skill Capped more effectively.
                </p>
              </div>
              <div className="home-section">
