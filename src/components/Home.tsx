          ...
          <div className="columns">
            <div className="column is-three-fifths is-offset-one-fifth">
              ...
              <div className="home-section">
                ...
                <p>
                  Skill Capped embed a JSON manifest in their HTML. This JSON manifest contains data about all of the
                  videos on their website such as the title, description, etc. This embedded JSON is downloaded and
                  parsed as a part of this web app. All of the content on this web app is created through this JSON
                  data.
                </p>
              </div>
            </div>
